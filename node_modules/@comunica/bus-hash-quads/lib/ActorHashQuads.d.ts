 ...
 */
export declare abstract class ActorHashQuads extends Actor<IActionHashQuads, IActorTest, IActorHashQuadsOutput> {
    /**
     * @param args - @defaultNested {<default_bus> a <cc:components/Bus.jsonld#Bus>} bus
     */
    constructor(args: IActorHashQuadsArgs);
}
...
export type IActorHashQuadsArgs = IActorArgs<IActionHashQuads, IActorTest, IActorHashQuadsOutput>;
export type MediatorHashQuads = Mediator<Actor<IActionHashQuads, IActorTest, IActorHashQuadsOutput>, IActionHashQuads, IActorTest, IActorHashQuadsOutput>;
