...
import type { IPhysicalQueryPlanLogger, QueryExplainMode, IProxyHandler, ICliArgsHandler, IDataDestination, MetadataBindings, FunctionArgumentsCache, IAggregatedStore, QuerySourceUnidentified, IQuerySourceWrapper, QuerySourceReference, IStatisticBase, IDiscoverEventData, ILink } from '@comunica/types';
