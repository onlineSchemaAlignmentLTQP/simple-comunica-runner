            ...
            const bindingsStream = new bus_query_operation_1.ClosableTransformIterator(async () => {
                await new Promise((resolve) => {
                    buffer.bindingsStream.on('data', (data) => {
                        index[bus_rdf_join_1.ActorRdfJoin.hashNonClashing(data, commonVariables)] = true;
                    });
                ...
                return output.bindingsStream.filter(data => !index[bus_rdf_join_1.ActorRdfJoin.hashNonClashing(data, commonVariables)]);
            }, {
                autoStart: false,
                onClose() {
